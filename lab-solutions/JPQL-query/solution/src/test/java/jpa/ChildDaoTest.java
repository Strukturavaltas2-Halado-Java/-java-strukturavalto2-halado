...
class ChildDaoTest {
    ...
    @Test
    void testQuery1() {
        List<Child> expected = childDao.findChildrenQuery1(2016);
    ...
    @Test
    void testQuery4() {
        Child expected = childDao.findChildQuery4("person1", 2015);
    ...
    @Test
    void testQuery7() {
        List<Child> expected = childDao.findChildrenQuery7();
