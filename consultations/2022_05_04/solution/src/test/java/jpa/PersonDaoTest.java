...
class PersonDaoTest {
    ...
    @Test
    void testQuery2() {
        List<Person> expected = personDao.findPeopleQuery2();
    ...
    @Test
    void testQuery3() {
        Person expected = personDao.findPersonQuery3();
    ...
    @Test
    void testQuery5() {
        Person expected = personDao.findPersonQuery5("child6");
    ...
    @Test
    void testQuery6() {
        double expected = personDao.findQuery6();
